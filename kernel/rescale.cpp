...
#pragma HLS INLINE off
	...
	intt_4core_mods<2, CORENUM, BRAMNUM, BRAMSIZE, STAGEMAX>(
		encrypted0, idt0, sidt0, modulus0);
	intt_4core_mods<2, CORENUM, BRAMNUM, BRAMSIZE, STAGEMAX>(
		encrypted1, idt1, sidt1, modulus1);
	intt_4core_mods<2, CORENUM, BRAMNUM, BRAMSIZE, STAGEMAX>(
		encrypted2, idt2, sidt2, modulus2);
}
...
#pragma HLS INLINE off
	...
	ntt_4core_new<CORENUM, BRAMNUM, BRAMSIZE, STAGEMAX, 1>(
...
#pragma HLS INLINE off
	...
	ntt_4core_mods<2, CORENUM, BRAMNUM, BRAMSIZE, STAGEMAX>(
		encrypted0, rp0, srp0, modulus0);
	ntt_4core_mods<2, CORENUM, BRAMNUM, BRAMSIZE, STAGEMAX>(
		encrypted1, rp1, srp1, modulus1);
	ntt_4core_mods<2, CORENUM, BRAMNUM, BRAMSIZE, STAGEMAX>(
		encrypted2, rp2, srp2, modulus2);
}
