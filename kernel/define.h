...
#define NN 32768 // 16384

#define CORENUM 4 // init 4
#define BRAMNUM 8 // init 8
#define BRAMSIZE 1024
#define STAGEMAX 10 // init 10

#define L_BRAMNUM 4
#define L_BRAMSIZE 10
#define L_N 14

#define RPBRAMNUM 4 // 4
#define RPBRAMSIZE 4096
#define logRPBRAMNUM 2
#define L_RPBRAMNUM 2 // 2
#define L_RPBRAMSIZE 11 // 11

// temp-----------------------
#define STAGE1_MAX 10 // 10
...
*/
#define INITMODCOUNT 5 // 这里修改了, init = 4
#define ROOTMODCOUNT 6

#define MODCOUNT1 6
#define MODCOUNT2 5
#define MODCOUNT3 4
#define MODCOUNT4 4 // init = 3
#define MODCOUNT5 2
#define MODCOUNT6 1
